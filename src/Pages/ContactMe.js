            ...
            <div className=" min-h-screen">
                <div data-aos="fade-up"
                    ...
                    <div data-aos="fade-right" className="w-full max-w-xl p-5 rounded-xl ">
                        <h3 className="text-md text-center underline underline-offset-2 py-3">Contact Info</h3>
                        ...
                        <div className='card'>
                            ...
                            <figure style={{ justifyContent: 'flex-start' }} className='flex items-center' >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-10" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div>
                            ...
                            <figure style={{ justifyContent: 'flex-start' }} className='flex items-center' >
                                ...
                                <address>Khorkhori bypass, Parila Rajshahi </address>
                            </figure>
                        </div>
                    </div>
                    <div data-aos="fade-left" className="card flex-shrink-0 w-full max-w-lg shadow-xl">
                        <div className="card-body">
                            <h3 className="text-md text-center underline underline-offset-2">Direct Mail</h3>
